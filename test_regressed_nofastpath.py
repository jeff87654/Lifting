"""Test the regressed combo with S_n fast path disabled, forcing the slow
lifting path. If this recovers the 8 groups, confirms that the S_n fast
path is missing the T10 <-> T6 (both isomorphic to S_6) full-isomorphism
diagonals.
"""
...
with open(r"C:\Users\jeffr\Downloads\Lifting\tmp_test_regress_nofp.g", "w") as f:
    f.write(code)
...
p = subprocess.Popen(
    [r"C:\Program Files\GAP-4.15.1\runtime\bin\bash.exe", "--login", "-c",
     'cd "/cygdrive/c/Program Files/GAP-4.15.1/runtime/opt/gap-4.15.1" && ./gap.exe -q -o 0 "/cygdrive/c/Users/jeffr/Downloads/Lifting/tmp_test_regress_nofp.g"'],
...
log = open(r"C:\Users\jeffr\Downloads\Lifting\test_regressed_nofp.log").read()
started = False
