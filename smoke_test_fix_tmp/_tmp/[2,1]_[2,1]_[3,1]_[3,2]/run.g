...
LogTo("/cygdrive/c/Users/jeffr/Downloads/Lifting/smoke_test_fix_tmp/_tmp/[2,1]_[2,1]_[3,1]_[3,2]/run.log");

ML            := 7;
MR            := 3;
TARGET_N      := ML + MR;
LEFT_PARTITION  := [2,2,3];   # block sizes desc, e.g. [4,4,4,4]
RIGHT_PARTITION := [3];
SUBS_LEFT_PATH   := "/cygdrive/c/Users/jeffr/Downloads/Lifting/smoke_test_fix_tmp/_tmp/[2,1]_[2,1]_[3,1]_[3,2]/subs_left.g";
SUBS_RIGHT_PATH  := "";
CACHE_LEFT_PATH  := "/cygdrive/c/Users/jeffr/Downloads/Lifting/smoke_test_fix_tmp/_h_cache/7/[3,2,2]/[2,1]_[2,1]_[3,1].g";
CACHE_RIGHT_PATH := "";
RIGHT_TG_D    := 3;       # 0 if right side is a source list
RIGHT_TG_T    := 2;
BURNSIDE_M2   := 0;   # 0 or 1
EMIT_GENS_PATH := "/cygdrive/c/Users/jeffr/Downloads/Lifting/smoke_test_fix_tmp/_tmp/[2,1]_[2,1]_[3,1]_[3,2]/fps.g";
