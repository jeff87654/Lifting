...
LogTo("C:/Users/jeffr/Downloads/Lifting/tmp_ab_rich_norich.log");
...
_HOLT_RICH_BUCKET_THRESHOLD := 1000000;;
t0 := Runtime();;
reps := HoltDedupUnderG(groups, Nfull);;
t := (Runtime() - t0) / 1000.0;;
Print("RESULT label=norich reps=", Length(reps), " time=", t, "s threshold=", _HOLT_RICH_BUCKET_THRESHOLD, "\n");
LogTo();
QUIT;
