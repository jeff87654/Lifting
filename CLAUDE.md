...
**Always run GAP tests in the background** using `run_in_background=true` so Claude can continue working while waiting. GAP computations often take 5-15+ minutes.
