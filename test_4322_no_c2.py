...
with open(r"C:\Users\jeffr\Downloads\Lifting\test_4322_no_c2_commands.g", "w") as f:
    f.write(gap_commands)

gap_runtime = r"C:\Program Files\GAP-4.15.1\runtime"
bash_exe = r"C:\Program Files\GAP-4.15.1\runtime\bin\bash.exe"
script_path = "/cygdrive/c/Users/jeffr/Downloads/Lifting/test_4322_no_c2_commands.g"
...
start = time.time()
print("Testing [4,3,2,2] with and without C2 optimization...")
