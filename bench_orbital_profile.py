"""Profile H^1 orbital path timing breakdown for [6,4,3] of S13."""
import subprocess
import os
import time
...
log_file = "C:/Users/jeffr/Downloads/Lifting/bench_orbital_profile.log"
...
script_path = os.path.join(LIFTING_DIR, "bench_orbital_profile.g")
with open(script_path, "w") as f:
    f.write(gap_code)

script_cygwin = "/cygdrive/c/Users/jeffr/Downloads/Lifting/bench_orbital_profile.g"
...
print("Running orbital profiling benchmark for [6,4,3]...")
start = time.time()
...
with open(os.path.join(LIFTING_DIR, "bench_orbital_profile.log"), "r") as f:
    log = f.read()

# Show key results
for line in log.split('\n'):
    if any(x in line for x in ['classes in', '===', 't_module', 't_h1', 't_action',
                                 't_orbits', 't_convert', 'orbit_time', 'total_orbits',
                                 'total_points', 'skipped', 'h1_calls', 'coprime',
                                 'fallback', 'h1_time', 'Profiling']):
        print(line.strip())
