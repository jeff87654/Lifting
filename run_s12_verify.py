###############################################################################
# run_s12_verify.py - Compute S12 with cache and verify
###############################################################################
...
log_file = "C:/Users/jeffr/Downloads/Lifting/s12_verify.log"
...
script_file = os.path.join(LIFTING_DIR, "s12_verify.g")
with open(script_file, "w") as f:
    f.write(gap_code)

script_cygwin = "/cygdrive/c/Users/jeffr/Downloads/Lifting/s12_verify.g"
...
print("Computing S12 (with S1-S11 from cache)...")
...
log_path = os.path.join(LIFTING_DIR, "s12_verify.log")
if os.path.exists(log_path):
    with open(log_path, "r") as f:
        log = f.read()
    # Print key partition results and summary
    for line in log.split("\n"):
        if any(k in line for k in ["S_12", "PASS", "FAIL", "Total", "Partition", "=> ", "classes"]):
            print(line)
else:
