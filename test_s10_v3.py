"""Test S10 computation with database - quit on errors."""
...
gap_commands = '''
# Quit on errors instead of entering break loop
OnBreak := function() FORCE_QUIT_GAP(1); end;
BreakOnError := false;
...
with open(r"C:\Users\jeffr\Downloads\Lifting\temp_s10_v3.g", "w") as f:
    f.write(gap_commands)

gap_runtime = r"C:\Program Files\GAP-4.15.1\runtime"
bash_exe = r"C:\Program Files\GAP-4.15.1\runtime\bin\bash.exe"
script_path = "/cygdrive/c/Users/jeffr/Downloads/Lifting/temp_s10_v3.g"
...
try:
    ...
    if stderr and "Syntax warning" not in stderr and "Unbound global" not in stderr:
        ...
        stderr_clean = stderr.replace("Syntax warning", "").strip()
        if stderr_clean:
            print("\nSTDERR (last 1000 chars):", stderr[-1000:])
