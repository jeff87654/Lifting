...
LogTo("C:/Users/jeffr/Downloads/Lifting/tmp_h1_section_s17_5552_off1.log");
...
ResetH1OrbitalStats();
pack := BuildCombo();
Print("CASE s17_5552_off1 section=", H1_OUTER_SECTION_ACTION,
      " |P|=", Size(pack[1]), " |N|=", Size(pack[4]), "\n");
t0 := Runtime();
res := HoltFPFSubgroupClassesOfProduct(pack[1], pack[2], pack[3], pack[4]);
elapsed := Runtime() - t0;
Print("RESULT s17_5552_off1 count=", Length(res), " elapsed_ms=", elapsed, "\n");
PrintH1OrbitalStats();
LogTo();
QUIT;
