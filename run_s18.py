###############################################################################
# run_s18.py - S18 conjugacy class computation
#
# Standalone orchestrator for computing conjugacy classes of subgroups of S18.
...
#   - 4 workers (conservative memory usage)
#   - 7-day timeout (effectively no timeout)
#
# Usage:
#   python run_s18.py --dry-run              # Preview assignment
#   python run_s18.py                        # Launch computation
#   python run_s18.py --workers 6            # Use 6 workers
#   python run_s18.py --resume               # Resume incomplete
#   python run_s18.py --resume-partitions "[5,4,4,3,2]"  # Resume specific
#   python run_s18.py --combine-only         # Assemble final cache
#
###############################################################################
...
MASTER_LOG = os.path.join(OUTPUT_DIR, "run_s18.log")
...
def main():
    parser = argparse.ArgumentParser(
        description=f"S{N} conjugacy class computation "
                    f"(per-combo output, -o 0)")
