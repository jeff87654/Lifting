###############################################################################
# run_s13_verify.py - Compute S13 with cache and verify
###############################################################################
...
log_file = "C:/Users/jeffr/Downloads/Lifting/s13_verify.log"
...
script_file = os.path.join(LIFTING_DIR, "s13_verify.g")
with open(script_file, "w") as f:
    f.write(gap_code)

script_cygwin = "/cygdrive/c/Users/jeffr/Downloads/Lifting/s13_verify.g"
...
print("Computing S13 (with S1-S12 from cache)...")
...
log_path = os.path.join(LIFTING_DIR, "s13_verify.log")
if os.path.exists(log_path):
    with open(log_path, "r") as f:
        log = f.read()
    # Print key partition results and summary
    for line in log.split("\n"):
        if any(k in line for k in ["S_13", "PASS", "FAIL", "Total", "Partition", "=> ", "classes"]):
            print(line)
else:
