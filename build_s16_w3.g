...
LogTo("C:/Users/jeffr/Downloads/Lifting/build_s16_w3.log");
...
_HEARTBEAT_FILE := "C:/Users/jeffr/Downloads/Lifting/parallel_sn/16/worker_3_heartbeat.txt";
PrintTo(_HEARTBEAT_FILE, "worker 3 starting n=16 partitions=",
    Length([[8,5,3],[12,2,2],[8,3,3,2],[6,4,4,2],[5,4,4,3],[11,5],[5,5,3,3],[5,4,3,2,2],[7,5,2,2]]), "\n");

my_partitions := [[8,5,3],[12,2,2],[8,3,3,2],[6,4,4,2],[5,4,4,3],[11,5],[5,5,3,3],[5,4,3,2,2],[7,5,2,2]];
total_fpf := 0;
...
od;
PrintTo(_HEARTBEAT_FILE, "worker 3 done total=", total_fpf, "\n");
