###############################################################################
# run_parallel.py - Parallel partition processing for S_n computation
#
# Distributes independent FPF partitions across N GAP worker processes.
# Each partition is independent - workers load precomputed caches and
# process assigned partitions, writing results to separate files.
#
# Usage:
#   python run_parallel.py <n> [--workers N] [--dry-run]
#
# Example:
#   python run_parallel.py 14 --workers 8
###############################################################################
