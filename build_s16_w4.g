...
LogTo("C:/Users/jeffr/Downloads/Lifting/build_s16_w4.log");
...
_HEARTBEAT_FILE := "C:/Users/jeffr/Downloads/Lifting/parallel_sn/16/worker_4_heartbeat.txt";
PrintTo(_HEARTBEAT_FILE, "worker 4 starting n=16 partitions=",
    Length([[9,4,3],[10,4,2],[6,6,4],[7,6,3],[7,5,4],[9,3,2,2],[8,2,2,2,2],[7,3,3,3],[4,3,3,3,3],[7,3,2,2,2],[5,5,2,2,2],[4,3,3,2,2,2]]), "\n");

my_partitions := [[9,4,3],[10,4,2],[6,6,4],[7,6,3],[7,5,4],[9,3,2,2],[8,2,2,2,2],[7,3,3,3],[4,3,3,3,3],[7,3,2,2,2],[5,5,2,2,2],[4,3,3,2,2,2]];
total_fpf := 0;
...
od;
PrintTo(_HEARTBEAT_FILE, "worker 4 done total=", total_fpf, "\n");
