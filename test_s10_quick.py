...
gap_commands = '''
LogTo("C:/Users/jeffr/Downloads/Lifting/test_s10_quick_output.txt");
Print("S10 Quick Test\\n");
Print("=============\\n\\n");
...
def main():
    ...
    with open(r"C:\Users\jeffr\Downloads\Lifting\test_s10_quick_commands.g", "w") as f:
        f.write(gap_commands)

    gap_runtime = r"C:\Program Files\GAP-4.15.1\runtime"
    bash_exe = r"C:\Program Files\GAP-4.15.1\runtime\bin\bash.exe"
    script_path = "/cygdrive/c/Users/jeffr/Downloads/Lifting/test_s10_quick_commands.g"
    ...
    try:
        ...
        output_file = r"C:\Users\jeffr\Downloads\Lifting\test_s10_quick_output.txt"
        if os.path.exists(output_file):
            ...
            with open(output_file, 'r') as f:
                content = f.read()
                # Show just the summary portion
                if "S10 Result" in content:
                    idx = content.find("S10 Result")
                    print(content[idx:])
