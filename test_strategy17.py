"""Test S2-S10 after Strategy 1.7 (general section-based complement finder)."""
import subprocess
import os
import time
...
log_file = "C:/Users/jeffr/Downloads/Lifting/test_strategy17.log"
...
script_path = os.path.join(LIFTING_DIR, "test_strategy17.g")
with open(script_path, "w") as f:
    f.write(gap_code)

script_cygwin = "/cygdrive/c/Users/jeffr/Downloads/Lifting/test_strategy17.g"
...
print("Running S2-S10 with Strategy 1.7...")
start = time.time()
...
with open(os.path.join(LIFTING_DIR, "test_strategy17.log"), "r") as f:
    log = f.read()

for line in log.split('\n'):
    if any(x in line for x in ['PASS', 'FAIL', 'ALL', 'Total', 'SOME', 'cache', 'Cache',
                                 'H1', 'Fallback', 'invalid', 'falling']):
        print(line.strip())
...
if warning_count > 0:
    ...
    print("\nNo invalid complement warnings")
