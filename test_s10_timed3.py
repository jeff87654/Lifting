...
log_file = "C:/Users/jeffr/Downloads/Lifting/test_s10_timed3_output.txt"
...
print(f"Running S10 timed test (with fail-handling fix)...")
...
try:
    ...
    wall_end = time.time()
    print(f"Wall clock time: {wall_end - wall_start:.1f}s")
