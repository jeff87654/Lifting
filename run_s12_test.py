...
script = "/cygdrive/c/Users/jeffr/Downloads/Lifting/temp_s12_test.g"
...
try:
    with open(r"C:\Users\jeffr\Downloads\Lifting\gap_s12_test.log", "r") as f:
        log = f.read()
