"""Rerun W180: S17 partition [6,4,4,3] - resumed from checkpoint with unlimited memory."""
...
gap_commands = f'''
LogTo("{log_file}");
Print("W180 rerun v2: S17 [6,4,4,3] (unlimited memory)\\n");
...
with open(r"C:\Users\jeffr\Downloads\Lifting\parallel_s17\rerun\w180_v2.g", "w") as f:
    f.write(gap_commands)

gap_runtime = r"C:\Program Files\GAP-4.15.1\runtime"
bash_exe = r"C:\Program Files\GAP-4.15.1\runtime\bin\bash.exe"
script_path = "/cygdrive/c/Users/jeffr/Downloads/Lifting/parallel_s17/rerun/w180_v2.g"
...
stdout, stderr = process.communicate(timeout=72000)
