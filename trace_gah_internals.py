"""Trace GAH's per-hom internals on the divergent (Q, M_bar) case.
Reimplements GAH's loop in Python+GAP, dumping for each hom: validTaus,
Stab size, orbit reps, and the resulting K's.
"""
import subprocess, os

LOG = "C:/Users/jeffr/Downloads/Lifting/trace_gah.log"
...
tmp_path = r"C:\Users\jeffr\Downloads\Lifting\tmp_trace_gah.g"
...
p = subprocess.Popen(
    [r"C:\Program Files\GAP-4.15.1\runtime\bin\bash.exe", "--login", "-c",
     ...
     './gap.exe -q -o 0 "/cygdrive/c/Users/jeffr/Downloads/Lifting/tmp_trace_gah.g"'],
