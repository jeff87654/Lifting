...
Print("\\n--- Test: Partition [3,2,2,2] in S9 ---\\n");
Print("Has S_3 acting on the three C_2 factors\\n\\n");
...
shifted3 := ShiftGroup(G3, 5);
shifted4 := ShiftGroup(G4, 7);
...
result := FindFPFClassesByLifting(P, [shifted1, shifted2, shifted3, shifted4], [0, 3, 5, 7]);
