"""Profile EVERYTHING the lifting does for one |Q|=115200 parent: Centralizer,
the dispatcher (which calls GAH), and the post-GAH PreImages + FPF check.
Times each step to find what dominates the 1000+ second per-parent cost we
see in v3's log.
"""
import subprocess, os

LOG = "C:/Users/jeffr/Downloads/Lifting/profile_parent9_full.log"
...
tmp_path = r"C:\Users\jeffr\Downloads\Lifting\tmp_profile_parent9.g"
...
p = subprocess.Popen(
    [r"C:\Program Files\GAP-4.15.1\runtime\bin\bash.exe", "--login", "-c",
     ...
     './gap.exe -q -o 0 "/cygdrive/c/Users/jeffr/Downloads/Lifting/tmp_profile_parent9.g"'],
