"""Quick S2-S10 verification after hom_P guard fix."""
import subprocess
import os
import time
...
log_file = "C:/Users/jeffr/Downloads/Lifting/verify_s2_s10.log"
...
script_path = os.path.join(LIFTING_DIR, "verify_s2_s10.g")
with open(script_path, "w") as f:
    f.write(gap_code)

script_cygwin = "/cygdrive/c/Users/jeffr/Downloads/Lifting/verify_s2_s10.g"
...
with open(os.path.join(LIFTING_DIR, "verify_s2_s10.log"), "r") as f:
    log = f.read()
print(log[-500:])
