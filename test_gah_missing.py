"""Run multiple GAH trials, identify the missing K (relative to NSCR's
ground truth of 10), then walk through GAH's enumeration step-by-step to
see WHY the missing K wasn't built.
"""
import subprocess, os

LOG = "C:/Users/jeffr/Downloads/Lifting/test_gah_missing.log"
...
tmp_path = r"C:\Users\jeffr\Downloads\Lifting\tmp_test_gah_missing.g"
...
p = subprocess.Popen(
    [r"C:\Program Files\GAP-4.15.1\runtime\bin\bash.exe", "--login", "-c",
     ...
     './gap.exe -q -o 0 "/cygdrive/c/Users/jeffr/Downloads/Lifting/tmp_test_gah_missing.g"'],
