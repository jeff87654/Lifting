"""Rerun W178: S17 partition [8,4,3,2] - resumed from checkpoint with unlimited memory."""
...
gap_commands = f'''
LogTo("{log_file}");
Print("W178 rerun v2: S17 [8,4,3,2] (unlimited memory)\\n");
...
with open(r"C:\Users\jeffr\Downloads\Lifting\parallel_s17\rerun\w178_v2.g", "w") as f:
    f.write(gap_commands)

gap_runtime = r"C:\Program Files\GAP-4.15.1\runtime"
bash_exe = r"C:\Program Files\GAP-4.15.1\runtime\bin\bash.exe"
script_path = "/cygdrive/c/Users/jeffr/Downloads/Lifting/parallel_s17/rerun/w178_v2.g"
