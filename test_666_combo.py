"""Test [6,6,6]/[6,12]_[6,14]_[6,14] with verbose output to see which fast
path fires and why it returns 2 instead of 3.
"""
...
with open(r"C:\Users\jeffr\Downloads\Lifting\tmp_666.g", "w") as f:
    f.write(code)
...
p = subprocess.Popen(
    [r"C:\Program Files\GAP-4.15.1\runtime\bin\bash.exe", "--login", "-c",
     'cd "/cygdrive/c/Program Files/GAP-4.15.1/runtime/opt/gap-4.15.1" && ./gap.exe -q -o 0 "/cygdrive/c/Users/jeffr/Downloads/Lifting/tmp_666.g"'],
...
log = open(r"C:\Users\jeffr\Downloads\Lifting\test_666.log").read()
started = False
for line in log.splitlines():
    if "USE_GENERAL_AUT_HOM" in line or "TG(6,12)" in line:
        started = True
    if started:
        print(line)
