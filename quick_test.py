...
# Quick test - just S2-S8 for faster verification
gap_commands = '''
LogTo("C:/Users/jeffr/Downloads/Lifting/quick_test_output.txt");
Print("Quick S14 Optimization Verification Test\\n");
Print("==========================================\\n\\n");

Read("C:/Users/jeffr/Downloads/Lifting/lifting_method_fast_v2.g");

Print("\\n\\nTesting S2 through S8:\\n");
Print("========================\\n\\n");
...
def main():
    print("Launching GAP for quick verification test (S2-S8)...")
    print("Output will be logged to quick_test_output.txt")
    print()

    # Write GAP commands to a temporary file
    with open(r"C:\Users\jeffr\Downloads\Lifting\quick_test_commands.g", "w") as f:
    ...
    script_path = "/cygdrive/c/Users/jeffr/Downloads/Lifting/quick_test_commands.g"
    ...
    try:
        ...
        output_file = r"C:\Users\jeffr\Downloads\Lifting\quick_test_output.txt"
