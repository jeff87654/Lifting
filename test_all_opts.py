"""Test S2-S10 with all current optimizations."""
import subprocess
import os
import time
...
log_file = "C:/Users/jeffr/Downloads/Lifting/test_all_opts.log"
...
script_path = os.path.join(LIFTING_DIR, "test_all_opts.g")
with open(script_path, "w") as f:
    f.write(gap_code)

script_cygwin = "/cygdrive/c/Users/jeffr/Downloads/Lifting/test_all_opts.g"
...
print("Running S2-S10 with all optimizations...")
start = time.time()
...
with open(os.path.join(LIFTING_DIR, "test_all_opts.log"), "r") as f:
    log = f.read()
