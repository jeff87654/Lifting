"""Test GeneralAutHomComplements on two combos, with GAH verbose output:

  1. TG(6,16) x TG(12,242)                     (W501's stuck combo, partition [6,12])
  2. TG(2,1) x TG(4,3) x TG(6,3) x TG(6,14)    (partition [2,4,6,6])
"""
...
with open(r"C:\Users\jeffr\Downloads\Lifting\tmp_w501_4combo.g", "w") as f:
    f.write(code)
...
p = subprocess.Popen(
    [r"C:\Program Files\GAP-4.15.1\runtime\bin\bash.exe", "--login", "-c",
     'cd "/cygdrive/c/Program Files/GAP-4.15.1/runtime/opt/gap-4.15.1" && ./gap.exe -q -o 0 "/cygdrive/c/Users/jeffr/Downloads/Lifting/tmp_w501_4combo.g"'],
    stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, env=env,
    cwd=r"C:\Program Files\GAP-4.15.1\runtime",
    creationflags=subprocess.CREATE_NEW_PROCESS_GROUP)

print(f"Launched at PID {p.pid}")
print(f"Log: C:/Users/jeffr/Downloads/Lifting/w501_4combo.log")
