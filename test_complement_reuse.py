"""Test S2-S10 after complement reuse optimization."""
import subprocess
import os
import time
...
log_file = "C:/Users/jeffr/Downloads/Lifting/test_complement_reuse.log"
...
script_path = os.path.join(LIFTING_DIR, "test_complement_reuse.g")
with open(script_path, "w") as f:
    f.write(gap_code)

script_cygwin = "/cygdrive/c/Users/jeffr/Downloads/Lifting/test_complement_reuse.g"
...
print("Running S2-S10 with complement reuse optimization...")
start = time.time()
...
with open(os.path.join(LIFTING_DIR, "test_complement_reuse.log"), "r") as f:
    log = f.read()

for line in log.split('\n'):
    if any(x in line for x in ['PASS', 'FAIL', 'ALL', 'Total', 'H^1', 'Coprime']):
        print(line.strip())
