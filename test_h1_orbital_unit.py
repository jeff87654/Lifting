...
# Quick unit tests for H^1 orbital functions
gap_commands = '''
...
def main():
    print("Running H^1 Orbital Unit Tests")
    print("=" * 40)
    print()

    # Write GAP commands to a temporary file
    with open(r"C:\Users\jeffr\Downloads\Lifting\test_h1_orbital_unit_commands.g", "w") as f:
    ...
    script_path = "/cygdrive/c/Users/jeffr/Downloads/Lifting/test_h1_orbital_unit_commands.g"
    ...
    try:
        ...
        output_file = r"C:\Users\jeffr\Downloads\Lifting\test_h1_orbital_unit_output.txt"
