LogTo("C:/Users/jeffr/Downloads/Lifting/holt_engine/tests/diff_s16_844_v2.log");
Read("C:/Users/jeffr/Downloads/Lifting/lifting_method_fast_v2.g");
Read("C:/Users/jeffr/Downloads/Lifting/database/lift_cache.g");
Read("C:/Users/jeffr/Downloads/Lifting/holt_engine/loader.g");
USE_HOLT_ENGINE := true;
HOLT_ENGINE_MODE := "clean_first";
RESTART_AFTER_SECONDS := 0;     # disable restart mechanism for long-running test
CountAllConjugacyClassesFast(10);

# Iso-transport OFF run only. Expected count is 80189.
...
Print("\n[iso OFF] [8,4,4] = ", Length(r2), " in ", e2, "s (expected 80189)\n");
if Length(r2) = 80189 then
  Print("CORRECT -> iso-transport WAS the bug\n");
elif Length(r2) = 80188 then
