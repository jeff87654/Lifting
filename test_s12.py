...
# Full S12 from scratch
Print("=== Full S12 from scratch ===\\n");
startTime := Runtime();
result12 := CountAllConjugacyClassesFast(12);
Print("\\nS12 total: ", result12, " (expected 7312)\\n");
Print("S12 total time: ", (Runtime() - startTime) / 1000.0, "s\\n\\n");
...
try:
    with open(r"C:\Users\jeffr\Downloads\Lifting\gap_output_s12.log", "r") as f:
        log = f.read()
